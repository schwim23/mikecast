...
def _html_task(
    ...
    desc = (
        ...
        "     all-time-great. Routine non-NY recaps, opinion segments, coaching hires below "
        "     superstar caliber, and 'fun bar conversation' items DO NOT belong here.\n"
...
def _single_voice_task(
    ...
    desc = (
        ...
        "     non-NY recaps and 'fun bar conversation' items DO NOT belong here.\n"
...
def _conversational_task(
    ...
    desc = (
        ...
        "items DO NOT belong here. End with: \"Back to you, Mike.\"\n"
        "6. [MIKE] SIGN-OFF (~40w).\n\n"
        "Cut anything that isn't moving the listener forward. Prefer one specific "
