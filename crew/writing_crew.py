...
def _single_voice_task(
    ...
    desc = (
        ...
        f"{sports_facts}\n\n"
        f"Here are today's articles:\n{articles_context}{picks_ctx}\n\n"
        "TARGET LENGTH: 5–6 minutes of spoken audio at a natural ~140 wpm pace. "
        "That means a TOTAL of 700–850 words — not a word longer. Brevity is part "
        "of the brief.\n\n"
        "Segments with approximate word targets (sum ≈ 750):\n"
        "  1. INTRO (~50w) — warm welcome, tease top 2-3 stories.\n"
        "  2. AI & TECH (~250w) — top 2-3 stories. Substance over completeness.\n"
        "  3. BUSINESS & MARKETS (~150w) — top 1-2 stories with the why-it-matters.\n"
        "  4. COMPANIES (~200w) — top 2 stories with personality.\n"
        "  5. NY SPORTS (~70-100w) — per team, ONE sentence IF something noteworthy. "
        "     Skip teams with nothing. Add 1 sentence for major non-NY sports news if relevant.\n"
        "  6. MIKE'S PICKS (~80w) — only if picks exist; \"Big Mike's hand-picked reads\".\n"
        "  7. OUTRO (~30w) — wrap-up, sign-off.\n\n"
        "Cut everything that isn't moving the listener forward. Prefer one specific "
    ...
    expected = "Spoken-form podcast script, 700–850 words total."
    return desc, expected
...
def _conversational_task(
    ...
    desc = (
        ...
        "TARGET LENGTH: 5–6 minutes of spoken audio at ~140 wpm. "
        "TOTAL 700–850 words across all hosts — not a word longer. Brevity is part "
        "of the brief.\n\n"
        "Structure with approximate word targets (sum ≈ 750):\n"
        "1. [MIKE] INTRO (~50w) — welcome, tease top 2-3 stories.\n"
        "2. [ELIZABETH] AI & TECH (~250w) — top 2-3 stories with substance.\n"
        "3. [ELIZABETH] BUSINESS & MARKETS (~150w) — top 1-2 stories in depth.\n"
        "4. [ELIZABETH] COMPANIES (~150w) — top 2 with personality. "
        "End with: \"Alright Jesse, take it away with sports...\"\n"
        "5. [JESSE] NY SPORTS (~70-100w) — per NY team, ONE sentence IF noteworthy. "
        "Skip teams with nothing. Add 1 sentence for major non-NY sports if relevant. "
        "End with: \"Back to you, Mike.\"\n"
        "6. [MIKE] SIGN-OFF (~30w).\n\n"
        "Cut everything that isn't moving the listener forward. Prefer one specific "
        "fact over two vague ones. No URLs. No stage directions. Only spoken words."
    )
    expected = "Tagged 3-host script with [MIKE]/[ELIZABETH]/[JESSE] on own lines, 700–850 words total."
    return desc, expected
