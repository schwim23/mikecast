...
Calls Grok-2 (with live web search) to identify today's breaking stories
...
def plan_daily_searches() -> tuple[dict[str, list[str]], str]:
    """
    Call xAI Grok-2 to identify today's breaking stories and generate
    ...
    try:
        ...
        logger.info("Calling xAI Grok-2 for today's breaking stories…")
        ...
        # Validate: keep only known categories, ensure list of strings
        ...
        # Build trending context from the queries themselves
...
def _build_trending_context(dynamic_queries: dict[str, list[str]]) -> str:
    """
    Build a short trending-context paragraph from the dynamic queries.
    This is passed to scoring agents so they can weight breaking stories higher.
    """
